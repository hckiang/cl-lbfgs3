c  Originally by Nocedal and Morales:
c  
c  References
c  
c  R. H. Byrd, P. Lu and J. Nocedal. A Limited Memory Algorithm for Bound Constrained 
c  Optimization, (1995), SIAM Journal on Scientific and Statistical Computing , 16, 
c  5, pp. 1190-1208.
c  
c  C. Zhu, R. H. Byrd and J. Nocedal. L-BFGS-B: Algorithm 778: L-BFGS-B, FORTRAN 
c  routines for large scale bound constrained optimization (1997), ACM Transactions 
c  on Mathematical Software, Vol 23, Num. 4, pp. 550 - 560.
c  
c  J.L. Morales and J. Nocedal. L-BFGS-B: Remark on Algorithm 778: L-BFGS-B, FORTRAN 
c  routines for large scale bound constrained optimization (2011), ACM Transactions 
c  on Mathematical Software, Vol 38, Num. 1, pp. 7:1 - 7:4.
c  
c=========================================================================
c  
